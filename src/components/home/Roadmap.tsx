...
//        {/* تأثيرات الإضاءة الخلفية الهادئة */}
...
//               رحلة نمو <span className="text-transparent bg-clip-text bg-gradient-to-l from-emerald-300 via-emerald-400 to-green-500">مسارك المهني</span>
//             </h2>
...
//         {/* شبكة الكروت مع خط التوصيل الخلفي للشاشات الكبيرة */}
//         <div className="relative">
          
//           {/* خط التوصيل الأفقي (يظهر فقط في الشاشات الكبيرة خلف الكروت) */}
