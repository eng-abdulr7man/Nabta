...
const SupportPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050806] text-white flex flex-col font-tajawal selection:bg-emerald-500/30">
            ...
            <div className="bg-[#0a0f0c] border border-neutral-800/60 rounded-[2.5rem] p-8 lg:p-12 overflow-hidden relative">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
                ...
                <div className="lg:col-span-4 space-y-8">
                  ...
                  <div className="space-y-4">
                    <a href="https://wa.me/201019715490" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-2xl bg-[#121A15] border border-neutral-800 hover:border-[#25D366]/50 transition-all group">
                      <div className="w-12 h-12 rounded-xl bg-neutral-900 flex items-center justify-center group-hover:bg-[#25D366]/10 transition-colors">
                        <MessageCircle className="w-6 h-6 text-neutral-400 group-hover:text-[#25D366]" />
                      </div>
                      <div>
                    ...
                    <a href="mailto:wwwbgaro59@gmail.com" className="flex items-center gap-4 p-4 rounded-2xl bg-[#121A15] border border-neutral-800 hover:border-emerald-500/50 transition-all group">
                      <div className="w-12 h-12 rounded-xl bg-neutral-900 flex items-center justify-center group-hover:bg-emerald-900/30 transition-colors">
                        <Mail className="w-6 h-6 text-neutral-400 group-hover:text-emerald-500" />
                      </div>
                      <div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                      ...
                      <div className="space-y-2">
                        ...
                        <select 
                          ...
                          className="w-full bg-[#0a0f0c] border border-neutral-800 rounded-xl px-4 py-3.5 text-sm text-neutral-300 focus:outline-none focus:border-emerald-500/50 focus:bg-[#0a0f0c] transition-all appearance-none cursor-pointer"
                        >
                          <option value="">اختر نوع المشكلة...</option>
                          <option value="account">مشكلة في الحساب</option>
                          <option value="payment">استفسار عن الدفع</option>
                      ...
                      <Button 
                        type="submit"
                        disabled={loading}
                        className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 text-white px-8 h-12 text-base font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)] hover:shadow-[0_0_30px_rgba(16,185,129,0.4)] flex items-center justify-center gap-2"
                      >
                        {loading ? (
